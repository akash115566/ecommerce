...
const products = [
  {
    ...
    category: "Skin Care",
    productDescription:
      "A premium Ayurvedic soap crafted to gently cleanse the skin while leaving it feeling fresh, soft and nourished.",
    benefits: [
...

  {
    ...
    category: "Skin Care",
    productDescription:
      "A luxurious Ayurvedic soap enriched with a refreshing floral-inspired experience for clean, soft and beautifully refreshed skin.",
    benefits: [
      "Gently cleanses the skin",
...

  {
    ...
    category: "Skin Care",
    productDescription:
      "A premium golden Ayurvedic soap designed for a gentle cleansing ritual that leaves the skin feeling smooth and refreshed.",
    benefits: [
...

  {
    ...
    category: "Skin Care",
    productDescription:
      "A premium Ayurvedic bathing bar created for a gentle and refreshing daily skin care ritual.",
    benefits: [
      "Gently cleanses the skin",
      "Helps maintain skin freshness",
      "Leaves skin feeling soft",
...

  {
    ...
    category: "Skin Care",
    productDescription:
      "A clean and elegant Ayurvedic soap designed to gently cleanse the skin and provide an everyday refreshing bathing experience.",
    benefits: [
